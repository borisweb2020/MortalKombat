...
export const logs = {
    ...
    hit: [
        ...
        '[playerDefence] задумался, но внезапно [playerKick] случайно влепил грубый удар локтем в пресс оппонента.',
        '[playerDefence] ковырялся в зубах и в это время [playerKick] сконцентрировшись влепил тяжелый удар пальцем в кадык врага.',
        ...
        '[playerDefence] замешкался и [playerKick] проведя отвлекающий удар, нанес тяжелейший удар в грудь соперника.',
        '[playerDefence] пытался что-то сказать, а жестокий [playerKick] с разворота пяткой залепил прямо в челюсть противника.',
    ...
    defence: [
        ...
        '[playerKick] отвлекся на мгновение и потому у [playerDefence] получилось отпрыгнуть от удара кулаком куда обычно не бьют.',
